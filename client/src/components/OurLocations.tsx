...
export default function OurLocations() {
  ...
  const locations: LocationData[] = [
    ...
    },
    {
      ...
      name: "Las Tortillas Centro",
      type: "Restaurante Filial",
      shortDescription: "Nossa segunda localização no centro da cidade, mais perto de você.",
      description: "Nossa segunda localização estrategicamente posicionada no centro de Luanda para servir melhor nossos clientes. Este espaço mantém toda a qualidade e autenticidade do Las Tortillas original, oferecendo um ambiente moderno e acessível para quem trabalha ou vive na região central da cidade.",
      address: "Centro de Luanda, Luanda - Angola",
      phone: "+244 949 639 932",
      hours: "Segunda-Quinta: 11:00-23:00 | Sexta-Domingo: 11:00-01:00",
